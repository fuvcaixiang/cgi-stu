...
int cgiMain()
{
	...
	strcpy(sql, "create table information(sno int not null primary key, sname varchar(20) not null, sage int not null,sex char(10) not null,sdeptno int(4) not null)");
	...
	sprintf(sql, "insert into information values(%d, '%s', %d,'%s','%s')", atoi(sno), sname, atoi(sage),sex,sdeptno);
